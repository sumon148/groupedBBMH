...
```
This vignette demonstrates the use of the `groupedBBMH` package for analyzing group-testing data using hierarchical Beta-Binomial models with imperfect test accuracy. We illustrate both maximum likelihood and Bayesian estimation approaches with a real biosecurity dataset. The vignette provides examples, diagnostics, and practical guidance for applying these models to pooled or grouped testing scenarios in biosecurity and surveillance.
